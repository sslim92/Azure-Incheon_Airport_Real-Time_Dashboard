...
| 이름 | 담당 |
|---|---|
| 김진우 | 데이터 프로세스 개발 · 시각화 · 프로젝트 관리 |
| 박상필 | 데이터 프로세스 개발 · 웹 구현 |
| 박형진 | 데이터 프로세스 개발 · 데이터 품질 관리 |
| 서상원 | 데이터 프로세스 개발 · ML 분석 |
| 송누림 | 데이터 프로세스 개발 · 파이프라인 설계 · 시각화 |
| **임승수** | **실시간 ETL 파이프라인 · ML 모델 개발 · 트러블슈팅** |
